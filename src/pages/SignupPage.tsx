      ...
      >
        <div className="bg-[#0B0F17]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl text-white mb-2">Create your SES Feed account</h1>
            <p className="text-gray-400">Start making your social presence machine-readable.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              ...
              className="w-full bg-accent hover:bg-accent/90 text-accent-foreground rounded-full py-6 shadow-lg shadow-accent/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
